...
import com.leblon.app.dto.ChangePasswordDTO;
import com.leblon.app.dto.EmailValuesDTO;
import com.leblon.app.dto.VerificationEmailDTO;
...
public class EmailController {
    ...
    public ResponseEntity<?> sendEmailRecover(@RequestBody EmailValuesDTO dto) {
        ...
        try {
            ...
            response.put("mensaje", "Revisa tu correo electrónico y sigue las instrucciones para cambiar tu contraseña.");
        }catch (Exception e){
            response.put("mensaje", "Hubo un problema al intentar enviar el correo.");
